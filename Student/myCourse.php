          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                <div class="card-body">
                  ...
                  <a href="watchcourse.php?course_id=<?php echo $row['course_id'] ?>" class="btn btn-primary mt-5 float-right">Start Course</a>
                </div>
                
              </div>
              <div class="col-sm-3">
                <img src="../image/qrcode.jpg" class="card-img-top mt-1" alt="pic"> 
              </div>
