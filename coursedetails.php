...
<!-- Check if course is already Enroll -->
    ...
    <div class="container-fluid bg-dark"> <!-- Start Course Page Banner -->
      <div class="row">
        <img src="./image/Online_Le.jpg" alt="courses" style="height:200px; width:100%; object-fit:cover; box-shadow:10px;"/>
      </div> 
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <form action="checkout.php" method="post">
                      ...
                      <button type="submit" id="enrollnow" class="btn btn-primary text-white font-weight-bolder float-right" name="buy">Enroll Now</button>
                    </form>
                  </div>
                </div>
