...
?>
  <div class="col-sm-9 mt-5">
    <div class="row mx-5 text-center">
      ...
      <div class="col-sm-4 mt-5">
        <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
          <div class="card-header">Total Enrolled</div>
          <div class="card-body">
            <h4 class="card-title">
              <?php echo $totalenroll; ?>
            </h4>
            <a class="btn text-white" href="enrollReport.php">View</a>
          </div>
        </div>
      </div>
    </div>
    <div class="mx-5 mt-5 text-center">
      <!--Table-->
      <p class=" bg-dark text-white p-2">Course Enrolled Details</p>
      <?php
      $sql = "SELECT * FROM courseorder INNER JOIN course ON courseorder.course_id=course.course_id";
      $result = $conn->query($sql);
